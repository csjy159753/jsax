...
public class PolygonNodeTriangle {
    ...
    public static void main(String[] args) {
        ...
        allPoint.add(point3);
        allPoint.add(point4);
        List<double[]> allPointa = new ArrayList();
        allPointa.add(point1);
        allPointa.add(point2);
        allPointa.add(point3);
        allPointa.add(point4);
        allPointa.add(point1);
        ...
        double[] doubles = polygonCenterPoint.polygonGravityPoint("POLYGON ((31.70013 118.363094,31.697501 118.414421, 31.655281 118.392448, 31.6696 118.351421, 31.70013 118.363094))");

        System.out.println("================================================");
        PolygonNodeTriangle.polygonGravityPoint(allPointa);
    }
     ...
     * @return
     */
    public  static double[] polygonGravityPoint(List<double[]> list) {
        PolygonNodeTriangle polygonCenterPoint = new PolygonNodeTriangle();
        String strlist = "";
        for (int i = 0; i < list.size(); i++) {
            if (i + 1 == list.size()) {
                strlist += list.get(i)[0] + " " + list.get(i)[1];
            } else {
                strlist += list.get(i)[0] + " " + list.get(i)[1] + ",";
            }
        }
        double[] doubles = polygonCenterPoint.polygonGravityPoint(String.format("POLYGON ((%s))", strlist));
        return doubles;
    }

...
public class Operation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建一个点
        org.locationtech.jts.geom.Point point1 = op.createPointByWkt("point(20 10 )");
        // 创建一个面
...
//        System.out.println(op.intersectionGeo(s_1_2_7_4_6_5_3_1, s_1_3_4));
     ...
     */
    public org.locationtech.jts.geom.Point createPointByWkt(String wkt) throws ParseException {
        WKTReader reader = new WKTReader(geometryFactory);
        org.locationtech.jts.geom.Point point = (Point) reader.read(wkt);
        return point;
    }

...
public class QRCodeUtil {
     ...
     */
    public static boolean onlineCodeCreate(String content, String path, Integer size, String logoPath) {
        try {
            //图片类型
     ...
     */
    public static boolean onlineCodeCreate(File qrPic, File logoPic, String path) {
        try {
     ...
     * @return
     */
    public static Result onlineCodeAnalyze(String path) {
        try {
